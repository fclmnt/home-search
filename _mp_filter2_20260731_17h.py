...
c = json.load(open('_mp_candidates_20260731_17h.json'))
...
json.dump(kept, open('_mp_kept_20260731_17h.json', 'w'), ensure_ascii=False, indent=1)
json.dump(dropped_no_info, open('_mp_noinfo_20260731_17h.json', 'w'), ensure_ascii=False, indent=1)
